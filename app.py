...
print("\nWelcome to the Flower Shop!\n" + "Here is a list of all the flowers we have in stock! Feel Free to take a look and order whenever youre ready!\n")
print("         |**\\OUR FLOWERS/**|")
print("--Rose: $1.49 | Color: R | IN STOCK--")
print("--Iris: $1.99 | Color: V | IN STOCK--")
print("--Lily: $2.50 | Color: O | IN STOCK--")
print("\nPlease Fill out the order sheet, with the amount of flowers, type of flower")
...
print("LILES:: " + quantity3 + " at $2.50 per flower | Total: $" + str(float(quantity3)*2.50))
